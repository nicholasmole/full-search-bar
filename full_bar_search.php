...
function FullSearchBarCSS(){
  wp_register_style( 'full-bar-search', plugins_url('full-search-bar').'/src/css/search-form-style.css', [], '5.0.1' );
  ...
  ?>
    <form role="search" method="get" class="search-form" action="<?php echo esc_url( home_url( '/' ) ); ?>">
      <label> 
        ...
        <input onfocus="searchClickToggleCSS()" type="search" class="search&#45;field" placeholder="<?php echo esc_attr_x( 'Press Enter to Search...', 'placeholder', 'visual&#45;composer&#45;starter' ); ?>" value="<?php echo get_search_query(); ?>" name="s" /> 
      </label> 
